...
class ImageNet_data():
    def __init__(self, args):
        super(ImageNet_data).__init__()
        self.args = args
        self.filepath = './dataset/ImageNet/'
        self.download = True
    ...
    def load_data(self):
        ...
        self.train_valid_dataset = datasets.ImageNet(root=self.filepath, split='train', download=self.download, transform=self.transform)
        self.test_dataset = datasets.ImageNet(root=self.filepath, split='val', download=self.download, transform=self.transform)
