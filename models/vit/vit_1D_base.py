...
class Model(nn.Module):
    def __init__(self, input_dim, target_dim, patch_size=16, dim=256, depth=12, heads=12, mlp_dim=3072, pool = 'cls', channels = 1, dim_head = 64, dropout = 0.1, emb_dropout = 0.1):
        super().__init__()
